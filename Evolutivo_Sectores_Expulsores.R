...
# Script Independiente: Evolución Histórica de Sectores EXPULSORES
# ==============================================================================
...
# ==============================================================================
# 2. MOTOR DE CÁLCULO DE TRANSICIONES (ENFOQUE EXPULSORES)
# ==============================================================================
analizar_ranking_expulsores <- function(f_inicio, f_final, nombre_periodo) {
  ...
  resultado <- data.table(
    ...
    flujo_neto    = f_neto,
    # CAMBIO CLAVE: Ascendente. Rankea #1 al sector con flujo neto más negativo
    rank_expulsor = rank(f_neto, ties.method = "first"), 
...
# ==============================================================================
res_2001     <- analizar_ranking_expulsores(199812, 200209, "Fin de la Convertibilidad\n(1998-2002)")
res_subprime <- analizar_ranking_expulsores(200810, 200908, "Crisis Subprime\n(2008-2009)")
res_2018     <- analizar_ranking_expulsores(201803, 201912, "Crisis Cambiaria/Local\n(2018-2019)")
...
# Top 5 dinámico de Expulsores
codigos_top5_historico <- historico_rankings[rank_expulsor <= 5, unique(codigo)]
...
plot_evolucion[, orden_visual := rank(rank_expulsor), by = Periodo]
...
# ==============================================================================
grafico_ranking_expulsores <- ggplot(plot_evolucion, aes(x = Periodo, y = orden_visual, group = desc_corta, color = desc_corta)) +
  
  geom_line(linewidth = 1.5, alpha = 0.85) +
  geom_point(size = 9) +
  
  geom_text(aes(label = rank_expulsor), color = "white", fontface = "bold", size = 4) +
  ...
  labs(
    title = "Evolución de los Principales Sectores Expulsores de Empleo",
    subtitle = "Trayectoria del ranking de los sectores que integraron el Top 5 de expulsión neta en alguna de las crisis.",
    x = NULL,
    y = NULL,
...
print(grafico_ranking_expulsores)
ggsave("Historico_Expulsores_Legible.png", plot = grafico_ranking_expulsores, width = 20, height = 8.5, dpi = 300)
